# Converts the PASCAL VOC XML format into TFRecord.
...
flags.DEFINE_string('images_dir', '', 'Path to directory of images, needs to be absolute path')
flags.DEFINE_string('labels_dir', '', 'Path to directory of labels. needs to be absolute path')
FLAGS = flags.FLAGS
...
def create_tf_example(example):
    ...
    classes_text = ['roger federer'.encode('utf-8')]
    classes = [1]
